...
// console.log(parseFloat('2.5rem')); This also works, but always encouraged to use on Number object
...
// console.log(new Date('Sun Jan 12 2025 10:55:52'));
...
console.log(new Date(1736647894973));
