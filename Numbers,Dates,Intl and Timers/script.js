...
btnSort.addEventListener('click', function (e) {
  e.preventDefault();
  displayMovements(currentAccount.acc.movements, !sorted); // I changed according to the comments on the tutorial. Added acc. before movements.
  sorted = !sorted;
});
...
// we can get number output by not using the Number object but now in modern JS it is recommended to use it.
...
//console.log(Number(Number(2.234).toFixed(2))); // Research: ChatGPT's recommendation!
...
console.log(5 % 2);
// console.log(Math.floor(5 / 2)); // Research!
console.log(5 / 2);
console.log(8 % 3);
...
console.log(new Date('Fri Feb 21 2025 18:42:56'));
